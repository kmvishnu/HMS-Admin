...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="h-16 border-b border-[var(--color-border)] glass sticky top-0 z-40 px-6 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4 ml-4">
        ...
        <div className="h-8 w-8 rounded-full bg-gradient-to-tr from-purple-500 to-cyan-500 p-[2px]">
